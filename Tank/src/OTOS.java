...
public class OTOS {
	...
	public OTOS(Image image, double x, double y, double width, double height,
	...
	synchronized Vector<OTOS> overlaps() {
		...
		for (int counter = 0; counter < everybody.size(); counter++) {
			...
			if (other != this.sprite) {
				...
				// right xvalue of other is within sprite left and right x
				// values upper y value of other is contained by sprite y values
				// lower other y value is contained by sprite y values
				// { X value of other is contained by x values of sprite } { X
				// value of other is contained by x values of sprite }
